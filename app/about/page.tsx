  ...
  return (
    <div className='text-white font-poppins flex flex-col justify-center items-center m-5'>
        <div className='flex flex-col justify center items-center'>
            ...
            <p className='w-[800] p-4'>MedFolio is revolutionizing healthcare by creating a secure, global network for patient records management using blockchain technology.</p>
        </div>
        <div className='grid grid-cols-2 gap-6 m-4 '>
            <div className='w-[500] bg-slate-800 p-6 rounded-md'>
        ...
        <div className='w-[1020] bg-slate-800 p-6 rounded-md'>
